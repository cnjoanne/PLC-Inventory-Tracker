...
SRC = $(SRC_DIR)/main.c  $(SRC_DIR)/csv_parser.c $(SRC_DIR)/binary_cache.c $(SRC_DIR)/sorting.c $(SRC_DIR)/filtering.c $(SRC_DIR)/instruction_printer.c $(SRC_DIR)/utils.c ## $(SRC_DIR)/latex_export.c 
